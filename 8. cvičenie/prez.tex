...
\begin{frame}[fragile=singleslide]\frametitle{Skuska Odrazok}
\begin{itemize}
\item Skuska odrazky prvej urovne
	\begin{itemize}
	\item Skuska odrazky druhej urovne
	\end{itemize}
\end{itemize}
\end{frame}

\begin{frame}[fragile=singleslide]\frametitle{Prvky herneho dizajnu}
Pri aplikacii gamifikacie su prvky herneho dizajnu klucom k uspechu.  Ich hlavnou ulohou je navrhovat pravidla spravania sa veci v hre a potom tieto pravidla zvycajne implementovat.
...
\begin{frame}[fragile=singleslide]\frametitle{Gamifikacia}
\begin{itemize}
\item Hry
\item Herny dizajn -- \emph{vacsi pozitok}
%\item \emp{Hry su klucom k tvorivosti} % príkaz definovaný v preambule
...
\includegraphics[scale=.35]{hernydizajn.pdf}
